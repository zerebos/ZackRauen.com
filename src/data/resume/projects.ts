export const key = [
    {
        title: "BetterDiscord",
        type: "Open Source",
        link: "https://github.com/BetterDiscord/BetterDiscord",
        description: "Created and led a widely adopted client modification for Discord, using React, Node, and reverse-engineering techniques to integrate cleanly with a closed-source platform. Grew the project to ~9,000 GitHub stars and over 50M downloads, establishing it as the most popular Discord mod.",
    },
    {
        title: "betterdiscord.app",
        type: "Open Source",
        link: "https://github.com/BetterDiscord/betterdiscord.app",
    ...
    },
    {
        ...
        type: "Open Source",
        link: "https://github.com/zerebos/ghostty-config",
        description: "Developed a macOS-style configuration UI for the Ghostty terminal using SvelteKit SPA mode, with automated updates powered by AI-driven maintenance workflows. Reached 3,000+ GitHub stars and is actively used by the Ghostty community and is influencing plans for future native settings UI integration.",
    },
    {
        title: "Trilium Notes",
        type: "Open Source",
        link: "https://github.com/TriliumNext/Trilium",
        description: "Contributed major improvements to the Trilium Notes ecosystem, including a full rewrite of the extension system, a redesign of public share pages, and improvements to both developer tooling and user-facing extensions. Helped revitalize the project, leading to a surge of community contributions and 10,000+ new GitHub stars.",
    },
    {
        title: "CLI Tools",
        type: "IBM Internal",
        description: "Modernized internal IBM CLI tools by rewriting system-dependent utilities in Go for cross-platform compatibility, including mainframe support. The new tools became widely adopted across teams due to improved usability and local development workflows. Used real developer feedback to make improvements over existing systems.",
    },
    {
        title: "DumpXTR",
        type: "IBM Internal",
        description: "Revived a defunct mainframe memory-dump extraction library by converting it into a modern Go-based ecosystem with CLI tools, language bindings, and WASM support. Enabled multiple teams to build improved debugging workflows on top of the new system. Used internal AI coding agents to accelerate the conversion process.",
    },
    {
        title: "Homelab",
        type: "Personal",
        link: "https://cloud.zerebos.com",
        description: "Engineered a multi-server homelab environment with reproducible Docker deployments, automated backups, UPS-aware shutdown orchestration, custom dashboards, multi-node monitoring/analytics, and centralized log monitoring. Supports daily use by myself, friends, and family with production-grade reliability.",
    },
];
